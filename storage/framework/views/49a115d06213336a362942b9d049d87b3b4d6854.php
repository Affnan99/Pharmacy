            ...
            <div class="col-lg-6 col-12 mx-auto mt-5">
                <div class="card ">
                    <div class="card-header text-center">
                        ...
                        <span class="text-muted">Don't have an account? <a href="<?php echo e(url('register')); ?>">Register Here</a></span>
                    </div>
...
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\New Folder\Diploma In Ict-Hardy\Second Semester\React Projects\Asky File\Pharmacy\Laravel-Pharmacy-Management-System-master\resources\views/Auth/Login.blade.php ENDPATH**/ ?>