                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('register')); ?>"
                                class="nav-link <?php if(Session::has('Class')): ?> <?php echo e(Session::get('Class')); ?> <?php endif; ?>">REGISTER</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH C:\New Folder\Diploma In Ict-Hardy\Second Semester\React Projects\Asky File\Pharmacy\Laravel-Pharmacy-Management-System-master\resources\views/Layout/app.blade.php ENDPATH**/ ?>